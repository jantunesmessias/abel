...
/// The Studio-specific shape used to render a canonical visual projection.
///
/// Status, freshness, fidelity and the resource handle deliberately remain the
/// contract types owned by `devex_contracts`; the Studio must not invent a
/// second evidence model or infer a binding from filenames.
...
/// Projects only canonical bindings declared by the Host. A missing projection
/// is a collectable target; the Studio never invents one merely because an
/// Application happens to expose a Variant.
