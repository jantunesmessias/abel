...
public final class DevExFlutterPlugin implements
        FlutterPlugin,
        ActivityAware,
        MethodChannel.MethodCallHandler,
        PluginRegistry.NewIntentListener {
    private static final String CHANNEL = "devex.flutter/runtime-configuration-v1";
    private static final Pattern KEY = Pattern.compile("^DEVEX_[A-Z0-9_]{1,58}$");
