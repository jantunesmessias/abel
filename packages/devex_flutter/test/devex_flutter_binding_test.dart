...
void main() {
  ...
  testWidgets('binding is constructor-injected through the target scope', (
    ...
    late DevExFlutterBinding observed;
    ...
    await tester.pumpWidget(
      DevExTargetScope(
        ...
        child: Builder(
          builder: (context) {
            observed = DevExTargetScope.of(context);
  ...
  testWidgets('semantics identifier is independent from visible copy', (
    ...
    expect(
      tester.getSemantics(find.byType(DevExSemantics)).identifier,
      'sample.increment',
    );
    semantics.dispose();
  });
  ...
  testWidgets('App Adapter uploads a real widget capture into controller CAS', (
    ...
    final uploader = DevExAppAdapterCaptureUploader(client: originClient);
