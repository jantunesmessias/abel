...
void main() {
  test('ingests normalized results and explicitly referenced artifacts', () async {
    ...
    final lines = <String>[
      ...
      jsonEncode(<String, Object?>{
        'testID': 1,
        'message':
            'DEVEX_ARTIFACT_JSON:{"path":"artifacts/result.json","mediaType":"application/json","classification":"internal","role":"test-output"}',
        'type': 'print',
        'time': 5,
      }),
  ...
  test('rejects traversal markers and incomplete reporter streams', () async {
    ...
    final traversal = <String>[
      ...
      jsonEncode(<String, Object?>{
        'message':
            'DEVEX_ARTIFACT_JSON:{"path":"../secret","mediaType":"text/plain","classification":"sensitive","role":"unsafe"}',
        'type': 'print',
      }),
  ...
  test('collects the real Dart test machine reporter', () async {
    ...
    final summary = await provider.collect(
      ...
      targets: const <String>['packages/devex_testkit/test/testkit_test.dart'],
