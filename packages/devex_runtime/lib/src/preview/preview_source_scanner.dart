...
final class PreviewSourceScanner {
  ...
  static const String flutterCompatibility = '3.44.x';
  static const String _previewLibrary =
      'package:devex_preview/src/auto_preview.dart';
...
final class EphemeralPreviewRegistryWriter {
  ...
  Future<EphemeralPreviewRegistry> write({
    ...
    final output = p.join(toolRoot, 'devex', 'preview', safeDigest);
  ...
  String _registrySource(
    ...
    buffer
      ..writeln()
      ..writeln('typedef DevExPreviewFactory = Widget Function(BuildContext);')
      ..writeln()
      ..writeln(
        'final Map<String, DevExPreviewFactory> devexPreviewFactories =',
      )
      ..writeln('    <String, DevExPreviewFactory>{');
    for (final descriptor in manifest.descriptors) {
      final declaration =
          declarations[_declarationKey(
            descriptor.sourceUri,
