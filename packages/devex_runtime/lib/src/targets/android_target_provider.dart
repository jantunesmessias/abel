...
final class AndroidTargetProvider {
  ...
  Future<void> launch(String serial, AndroidLaunchRequest request) async {
    ...
    final values = <String, String>{
      'DEVEX_GATEWAY_ORIGIN': request.pairing.targetOrigin.toString(),
    ...
    // A cold, freshly installed Flutter debug build may spend well over the
    // generic ADB timeout in `am start -W`. Readiness is still proven below by
    // exact process and resumed-activity observations.
