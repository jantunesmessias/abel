...
void main() {
  ...
  final previewModule = ModuleDescriptor(
    ...
    configurationSchema: 'urn:devex:module:evidence.auto-preview:settings:v1',
  );
  ...
  test(
    ...
    () {
      ...
      final manifest = EffectiveKitManifest(
        ...
        rpcMethods: const <String>['devex.kit.describe'],
      ...
      final validator = Draft202012Validator(
        jsonDecode(
              File(
                p.join(_root(), 'schemas/v1/kit-composition.schema.json'),
              ).readAsStringSync(),
            )
            as Object,
      );
