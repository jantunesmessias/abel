...
Future<void> main(List<String> arguments) async {
  ...
  if (arguments.any(
    ...
    throw const FormatException(
      'Usage: dart run tool/target_server.dart '
  ...
  final launchAttemptId = Platform.environment['TARGET_LAUNCH_ATTEMPT_ID'];
  final targetId = Platform.environment['TARGET_ID'];
  final launchProfileId = Platform.environment['TARGET_LAUNCH_PROFILE_ID'];
  final readinessValues = <String?>[launchAttemptId, targetId, launchProfileId];
  if (readinessValues.any((value) => value != null) &&
      readinessValues.any((value) => value == null)) {
    throw const FormatException('Target readiness environment is incomplete');
  }
  stdout.writeln(
    jsonEncode(
      launchAttemptId == null
          ...
          : TargetReadinessRecord(
              launchAttemptId: TargetLaunchAttemptId(launchAttemptId),
              targetId: targetId!,
