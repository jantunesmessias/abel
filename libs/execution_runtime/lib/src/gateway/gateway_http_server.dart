...
final class GatewayHttpServer {
  ...
  Future<Response> _handle(Request request) async {
    ...
    if (requestOrigin != null && !allowedOrigins.contains(requestOrigin)) {
      return _error(403, 'GATEWAY_ORIGIN_DENIED');
    }
    if (request.method == 'OPTIONS' &&
        request.headers['access-control-request-method'] != null) {
      if (requestOrigin == null) {
        return _error(400, 'GATEWAY_PREFLIGHT_INVALID');
      }
    ...
    try {
      ...
      return _error(413, 'GATEWAY_REQUEST_TOO_LARGE', origin: requestOrigin);
    } on FormatException {
      return _error(400, 'GATEWAY_REQUEST_INVALID', origin: requestOrigin);
    } on Object {
      return _error(500, 'GATEWAY_INTERNAL', origin: requestOrigin);
    }
  }
