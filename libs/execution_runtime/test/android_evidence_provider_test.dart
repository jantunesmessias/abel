...
<hierarchy rotation="0"><node index="0" text="Jane Doe" resource-id="io.github.jantunesmessias.sample:id/email" class="android.view.View" content-desc="secret@example.test" clickable="true" enabled="true" bounds="[0,0][10,10]" /></hierarchy>
''');
    }
    if (command.endsWith('shell pidof io.github.jantunesmessias.sample')) {
      return _text('42\n');
    }
