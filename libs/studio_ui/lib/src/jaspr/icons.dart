...
final class StudioIcon extends StatelessComponent {
  const StudioIcon({required this.name, this.size = 18, super.key});

  final StudioIconName name;
  final double size;
  ...
  Component build(BuildContext context) {
    ...
    return switch (name) {
      StudioIconName.overview => lucide_dashboard.LayoutDashboard(
        width: dimension,
        height: dimension,
        classes: 'studio-ui-icon',
        attributes: attributes,
      ),
      StudioIconName.journey => lucide_route.Route(
        width: dimension,
        height: dimension,
        classes: 'studio-ui-icon',
        attributes: attributes,
      ),
      StudioIconName.target => lucide_monitor_play.MonitorPlay(
        width: dimension,
        height: dimension,
        classes: 'studio-ui-icon',
        attributes: attributes,
      ),
      StudioIconName.gateway => lucide_waypoints.Waypoints(
        width: dimension,
        height: dimension,
        classes: 'studio-ui-icon',
        attributes: attributes,
      ),
      StudioIconName.review => lucide_clipboard_check.ClipboardCheck(
        width: dimension,
        height: dimension,
        classes: 'studio-ui-icon',
        attributes: attributes,
      ),
      StudioIconName.remote => lucide_radio_tower.RadioTower(
        width: dimension,
        height: dimension,
        classes: 'studio-ui-icon',
        attributes: attributes,
      ),
      StudioIconName.hosted => lucide_cloud_cog.CloudCog(
        width: dimension,
        height: dimension,
        classes: 'studio-ui-icon',
        attributes: attributes,
      ),
      StudioIconName.map => lucide_map.Map(
        width: dimension,
        height: dimension,
        classes: 'studio-ui-icon',
        attributes: attributes,
      ),
      StudioIconName.list => lucide_list.List(
        width: dimension,
        height: dimension,
        classes: 'studio-ui-icon',
        attributes: attributes,
      ),
      StudioIconName.refresh => lucide_refresh.RefreshCw(
        width: dimension,
        height: dimension,
        classes: 'studio-ui-icon',
        attributes: attributes,
      ),
      StudioIconName.search => lucide_search.Search(
        width: dimension,
        height: dimension,
        classes: 'studio-ui-icon',
        attributes: attributes,
      ),
      StudioIconName.filters => lucide_filters.SlidersHorizontal(
        width: dimension,
        height: dimension,
        classes: 'studio-ui-icon',
        attributes: attributes,
      ),
      StudioIconName.zoomIn => lucide_zoom_in.ZoomIn(
        width: dimension,
        height: dimension,
        classes: 'studio-ui-icon',
        attributes: attributes,
      ),
      StudioIconName.zoomOut => lucide_zoom_out.ZoomOut(
        width: dimension,
        height: dimension,
        classes: 'studio-ui-icon',
        attributes: attributes,
      ),
      StudioIconName.fit => lucide_maximize.Maximize2(
        width: dimension,
        height: dimension,
        classes: 'studio-ui-icon',
        attributes: attributes,
      ),
      StudioIconName.capture => lucide_camera.Camera(
        width: dimension,
        height: dimension,
        classes: 'studio-ui-icon',
        attributes: attributes,
      ),
      StudioIconName.play => lucide_play.Play(
        width: dimension,
        height: dimension,
        classes: 'studio-ui-icon',
        attributes: attributes,
      ),
      StudioIconName.stop => lucide_square.Square(
        width: dimension,
        height: dimension,
        classes: 'studio-ui-icon',
        attributes: attributes,
      ),
      StudioIconName.success => lucide_circle_check.CircleCheck(
        width: dimension,
        height: dimension,
        classes: 'studio-ui-icon',
        attributes: attributes,
      ),
      StudioIconName.warning => lucide_alert.TriangleAlert(
        width: dimension,
        height: dimension,
        classes: 'studio-ui-icon',
        attributes: attributes,
      ),
      StudioIconName.disconnected => lucide_unplug.Unplug(
        width: dimension,
        height: dimension,
        classes: 'studio-ui-icon',
        attributes: attributes,
      ),
      StudioIconName.close => lucide_x.X(
        width: dimension,
        height: dimension,
        classes: 'studio-ui-icon',
        attributes: attributes,
