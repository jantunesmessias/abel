...
void main() {
  ...
  test('rejects Transition endpoints outside its Journey', () {
    final documents = _smallCatalog()
      ..add(
        _document(AuthoringKind.scenario, 'outside', <String, Object?>{
          'applicationId': 'app',
          'title': 'Outside',
        }),
      )
      ..add(
        _document(AuthoringKind.transition, 'outside-edge', <String, Object?>{
          'journeyId': 'flow',
          'from': 'first',
          'to': 'outside',
        }),
  ...
  test(
    'compiles 1000 scenarios and 5000 transitions within the local budget',
    () {
