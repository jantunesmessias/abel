...
final class GatewayRuntime {
      ...
      try {
        ...
        final response = GatewayResponse(
          ...
          headers: <String, String>{
            ...upstream.headers,
            'x-workspace-gateway': 'passthrough',
            'x-workspace-preset': _plan.preset.id.value,
          },
          body: upstream.body,
  ...
  GatewayResponse _denied({
    ...
    headers: <String, String>{
      ...
      'x-workspace-gateway': outcome == GatewayOutcome.unmatched
          ? 'denied'
          : outcome.name,
      'x-workspace-preset': _plan.preset.id.value,
    },
