...
void main() {
  group('CatalogManifest serialization', () {
    ...
    test(
      'constructors enforce the same public string bounds as the schema',
      () {
        expect(
          () => Workspace(
            id: WorkspaceId('workspace'),
            displayName: List<String>.filled(513, 'x').join(),
          ),
          throwsArgumentError,
        );
        expect(
          () => Scenario(
            ...
            title: List<String>.filled(2049, 'x').join(),
          ),
          throwsArgumentError,
        );
        expect(
          () => SourceReference(
            ...
            path: List<String>.filled(4097, 'x').join(),
          ),
          throwsArgumentError,
        );
      },
    ...
    test('rejects cross-Application Journey membership', () {
      final base = _manifest();
      final otherApplication = Application(
      ...
      final otherScenario = Scenario(
        id: ScenarioId('other-ready'),
      ...
      expect(
        () => CatalogManifest(
          ...
          layout: base.layout,
          workspace: base.workspace,
          applications: <Application>[...base.applications, otherApplication],
          journeys: <Journey>[
            Journey(
              id: JourneyId('cross'),
              applicationId: base.applications.single.id,
              title: 'Cross',
              scenarioIds: <ScenarioId>[otherScenario.id],
            ),
          ],
          scenarios: <Scenario>[...base.scenarios, otherScenario],
          transitions: const <Transition>[],
        ),
        throwsArgumentError,
      );
