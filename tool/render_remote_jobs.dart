...
void main(List<String> arguments) {
  if (arguments.length != 1) {
    stderr.writeln('usage: dart run tool/render_remote_jobs.dart OUTPUT_DIR');
    exitCode = 64;
    return;
  }
  ...
  final builder = KubernetesRemoteJobBuilder(
    KubernetesRemoteJobConfiguration(
      webWorkerImage:
          'registry.example.test/devex/worker-web@sha256:'
          '${_hex('a')}',
      androidWorkerImage:
          'registry.example.test/devex/worker-android@sha256:'
          '${_hex('b')}',
