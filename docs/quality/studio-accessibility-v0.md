# Auditoria de acessibilidade do Studio V0

Status: aprovada em 2026-08-09 para o gate V0 Flutter histórico. O renderer foi
removido; a evidência do Studio Jaspr atual está em
`docs/quality/studio-conformance-v1.md`.

Escopo histórico: esta auditoria cobre o Explore/Journey/Scenario mínimo e o
Journey Map V0 com catálogo fixture. Ela não comprova o shell SR, catálogo real
do Host, thumbnails/device frames, filtros, inspector ou seleção de providers.
Essas superfícies exigem nova conformance de acessibilidade em SR9; este
...
`apps/devex_studio/test/accessibility_test.dart` cobre targets rotulados,
...
`tool/studio_accessibility_driver.dart` usa Chrome DevTools Protocol somente
...
dart run tool/studio_accessibility_driver.dart \
  --port 38292 \
...
flutter test apps/devex_studio/test/accessibility_test.dart
```
...
## Integração posterior SR9

O vertical SR0–SR9 não reclassifica esta auditoria histórica como se o leitor de
...
A claim SR9 é, portanto, conformance automatizada de teclado/Semantics/reflow
