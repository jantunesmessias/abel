# ADR-0006: Gateway V0.1, HTTP e plano por artifacts
...
- O data plane V0.1 usa `shelf`/`dart:io`, aceita bodies de ate 256 KiB e fecha
...
e Evidence V0 continuam funcionais sem reinterpretar seus contratos.
