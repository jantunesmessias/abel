# ADR-0007: Gateway V0.2 hybrid, containment e credenciais
...
- Endpoints concretos vivem somente em `devex.local.yaml`, que e ignorado pelo
...
- Credencial persistente e apenas handle `env:DEVEX_*`; valor nunca entra em
...
`docs/architecture/v02-results.md`.

Rollback desabilita `gateway.hybrid` e o adapter de containment. Planos isolated,
CAS, evidence e sessoes V0.1 permanecem legiveis sem reinterpretacao.
