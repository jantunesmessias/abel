...
- Status: aceita e implementada em V5; certificação condicionada a cluster KVM
- Data: 2026-08-09
- Decisões afetadas: D-025, D-042…D-047

## Contexto

V5 precisa executar targets web e Android efêmeros em batch ou interativamente
...
- source/build remoto: transforma V5 em execução arbitrária de supply chain;
...
V5 requer CNI NetworkPolicy, Gateway API e, para Android, RuntimeClass/device
plugin/pool KVM dedicados. Desabilitar `remote.enabled` remove RBAC/token e deixa
V4/local intactos. Uma tentativa pode ser finalizada como unknown quando a
...
- `docs/architecture/v5-results.md` e threat model hosted/remote.
