...
`schemas/v1/android-evidence.schema.json`.
...
```text
devex target android evidence ...
devex evidence export-artifact ...
devex evidence compare-visual ...
devex evidence compare-semantics ...
```
