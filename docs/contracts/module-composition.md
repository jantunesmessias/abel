...
Status: contrato e runtime ativos na composição modular completa. Decisão: ADR-0012.
...
`schemas/distribution/kit-composition.schema.json` e usam JSON canônico/digest Abel.
...
settings usa o schema built-in referenciado pelo descriptor na fase configuração e resolver modular.
