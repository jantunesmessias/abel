...
`schemas/gateway/gateway-plan.schema.json`, usam `schemaVersion: 1`, kinds fechados,
...
Evidence, Release ou export e não pode declarar ambiente de produção. O contrato aceita
