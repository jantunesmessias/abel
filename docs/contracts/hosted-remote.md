...
`schemas/hosted/hosted-collaboration.schema.json` e
`schemas/hosted/remote-execution.schema.json`.
...
`docs/security/hosted-remote-threat-model.md` e resultados de control plane e execução remota.
