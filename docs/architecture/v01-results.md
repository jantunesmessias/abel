# Resultado executado do V0.1 Gateway isolated
...
- schema `schemas/v1/gateway-plan.schema.json` e codecs fail-closed;
...
substituicao operacional do gateway legado; esses gates pertencem a V0.2/V1.
