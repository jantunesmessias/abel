# Resultado executado do V2

Data: 2026-08-09. Baseline: Flutter 3.44.8, Dart 3.12.2, Linux x86_64.

## Entregue

- `.devexbundle` determinístico e offline, com manifest JCS, blobs por digest e
...
`tool/verify_v2.sh` terminou com exit `0`. Ele executou formatter, analyzer,
architecture guard, suites Dart/Flutter, widget/accessibility, Chromium real,
Gateway/containment, consumers e os testes V2.
...
V2 não afirma assinatura/attestation, plugin dinâmico fora de Linux/bubblewrap,
