# Resultado executado do V0.2 Gateway hybrid e containment
...
GatewayRoute upstreamOnly + UpstreamProfileId
  -> devex.local.yaml ignorado + credential handle
...
continuam em V1 ou depois de V5, conforme o registro arquitetural.
