...
- Status: aceita e implementada em hosted control plane; promoção de produção condicionada
- Data: 2026-08-09
...
1. hosted control plane é um modular monolith Dart que reutiliza Application Services do engine;
...
4. Identidade usa OIDC Authorization Code + PKCE S256. Abel não gerencia
...
transacional. Desabilitar hosted control plane remove link/auth hosted, mas não migra nem invalida
...
- rehearsal em `docs/architecture/hosted-control-plane-results.md` e runbook de recovery;
